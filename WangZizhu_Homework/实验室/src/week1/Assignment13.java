...
class BankAccount {
	...
	public void open(String name) {
		...
		System.out.println("开户成功！开户人："+"小明"+"，  账户："+(int)((Math.random()*9+1)*100000)+"，开户日期："+c.get(Calendar.YEAR)+"/"+month+"/"+c.get(Calendar.DAY_OF_MONTH)+" "+c.get(Calendar.HOUR_OF_DAY)+":"+c.get(Calendar.MINUTE)+"，余额："+money);
	}
